namespace RPG.Characters
{
	...
	public class MeleeProjectileTriggerable
		: MonoBehaviour
	{
		...
		[HideInInspector] public float MartialDmgModifier;
		...
		public void Launch()
		{
			...
			float damagePerShot = player.PhysicalAttackPower * MartialDmgModifier;
